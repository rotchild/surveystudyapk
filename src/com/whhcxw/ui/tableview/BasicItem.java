...
public class BasicItem implements IListItem {
	...
	private boolean bImageVisibility =true;
	...
	public boolean isbImageVisibility() {
		return bImageVisibility;
	}

	public void setbImageVisibility(boolean bImageVisibility) {
		this.bImageVisibility = bImageVisibility;
	}
