 ...
 * case to show a part of the content also when the drawer is closed/collapsed.
 * Use the 'semiClosedContentSize' attribute to specify how much of the content
 * (preferably in dips) that should be visible in closed/collapsed mode.
 * 
...
public class JasonClosedSlidingDrawer extends ViewGroup
{
     ...
     */
    public JasonClosedSlidingDrawer(Context context, AttributeSet attrs)
    {
     ...
     */
    public JasonClosedSlidingDrawer(Context context, AttributeSet attrs, int defStyle)
    {
        super(context, attrs, defStyle);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.JasonClosedSlidingDrawer, defStyle, 0);

        String orientation = a.getString(R.styleable.JasonClosedSlidingDrawer_orientation);
        mVertical = (orientation != null && orientation.equals("vertical"));
        mBottomOffset = (int) a.getDimension(R.styleable.JasonClosedSlidingDrawer_bottomOffset, 0.0f);
        mTopOffset = (int) a.getDimension(R.styleable.JasonClosedSlidingDrawer_topOffset, 0.0f);
        mAllowSingleTap = a.getBoolean(R.styleable.JasonClosedSlidingDrawer_allowSingleTap, true);
        mAnimateOnClick = a.getBoolean(R.styleable.JasonClosedSlidingDrawer_animateOnClick, true);
        mSemiClosedContentSize = (int) a.getDimension(R.styleable.JasonClosedSlidingDrawer_jasonClosedContentSize, 0.0f);

        int handleId = a.getResourceId(R.styleable.JasonClosedSlidingDrawer_handle, 0);
        if (handleId == 0)
        {
            throw new IllegalArgumentException("The handle attribute is required and must refer " + "to a valid child.");
        }

        int contentId = a.getResourceId(R.styleable.JasonClosedSlidingDrawer_content, 0);
        if (contentId == 0)
        {
